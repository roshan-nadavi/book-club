...
interface Props {
  ...
  myCurrentChapter: number | null;  // current reading progress for spoiler gating
  totalChapters: number | null;     // for building the chapter dropdown
...
// ---------------------------------------------------------------------------
// SpoilerMessage — renders a single private message, locked or visible
// ---------------------------------------------------------------------------
...
export default function PrivateConversationsView({
  ...
  async function selectRoom(roomId: string) {
    ...
    // Reset spoiler state when switching rooms
  ...
  // Chapter options for spoiler dropdown
                ...
                {rooms.map((room) => {
                  ...
                  return (
                    <li key={room.id}>
                      ...
                      >
                        <span className="text-sm font-semibold leading-snug truncate block text-black">
                          {title}
                        </span>
